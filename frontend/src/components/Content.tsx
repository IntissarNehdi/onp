    ...
    <div className="container">
      ...
      <section id="hero" ref={heroRef} className="hero-section text-center mb-5">
        ...
        <p className="lead text-justify">
          Sag Tschüss zu Papierchaos – die digitale Einreichung von Wahlvorschlagslisten für Hochschulwahlen ist da! Schnell und sicher.
          Diese Plattform ersetzt zum Großteil den alten, papierbasierten Prozess und macht den gesamten Ablauf effizienter. Wahlamt, Vertrauenspersonen und
          Kandidierende profitieren von einer benutzerfreundlichen Lösung, die die Einreichung, Überprüfung und den Druck von Dokumenten vereinfacht.
        </p>
      </section>
      ...
      <section id="info" ref={infoRef} className="info-section mb-5">
        ...
        <div className="col-md-12">
          <p className="lead text-justify">
            Mit der Plattform wird die Einreichung von Wahlvorschlagslisten schnell, einfach und digital. Die Vertrauensperson erstellt die Liste der
            ...
            unterschrieben werden können. Nach der Unterschrift sammelt die Vertrauensperson alle Unterlagen ein und sendet sie entweder per E-Mail als
            ...
            Regeln der Wahlordnung der TU Darmstadt eingereicht worden sind.
          </p>
        </div>
